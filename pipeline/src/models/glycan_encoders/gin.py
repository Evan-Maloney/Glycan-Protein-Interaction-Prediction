# Used Maxym's GNN.py to implement GIN
...
class GINGlycanEncoder(GlycanEncoder):
    def __init__(self, embedding_dim: int = 256, hidden_channels: int = 128):
        ...
        # Output layer
        self.linear = torch.nn.Linear(hidden_channels, embedding_dim)
    ...
    def forward(self, data):
        """Process a batch of molecular graphs through the GIN"""
