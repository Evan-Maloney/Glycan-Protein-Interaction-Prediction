...
class ZeroPredictor(BindingPredictor):
    ...
    def forward(self, 
        ...
        constant_value = 0.0 #0.016757234366309902
        zero_predict = torch.full(output_shape, constant_value, requires_grad=True)
        #print('zero', zero_predict)
