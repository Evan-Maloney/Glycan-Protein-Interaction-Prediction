...
def main():
    ...
    # 24% of each cluster and protein cluster class in the test set in combination (at random_state=42)
    
    # -------------Test size (% of glycans and proteins as combinations in test set): 24.0% -------------
    # train size: 68492, test size: 9472, total: 129489
    # train size: 52.89%, test size: 7.31%
    # test size % in terms of test/(training+test) size: 12.15%
    # Total % of dataset used: 60.21%
